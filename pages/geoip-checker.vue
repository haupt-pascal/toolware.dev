<template>
  ...
  <div class="input-container">
    <span class="disclaimer">
      ...
      <a href="https://ipapi.co">ipapi.co</a> to get your public IP. Ipapi is an
      completely open source tool to get your public IP address.
    </span>
    ...
    <div class="result-container">
      ...
      <div v-else>
        ...
        <p v-if="geoIP.country_name">Country Name: {{ geoIP.country_name }}</p>
