<template>
  ...
  <div class="input-container info-container">
    ...
    <h3>
      What is an good SPF-Record in general?
    </h3>
    <span class="along">
      v=spf1 a mx ~all
    </span>
    <h3>
      What is an good SPF-Record for Google Workspace?
    </h3>
    <span class="along">
      v=spf1 include:_spf.google.com ~all
    </span>
    <h3>
      What is an good SPF-Record for Microsoft 365?
    </h3>
    <span class="along">
  ...
  <div class="input-container info-container">
    <li class="along"><p>A</p><p class="along">Stands for including every A-Tag inside your dns, also subdomains</p></li>
    <div class="divider">&nbsp;</div>
    <li class="along"><p>MX</p><p class="along">Stands for including every MX-Tag inside your dns</p></li>
    <div class="divider">&nbsp;</div>
    <li class="along"><p>~all</p><p class="along">Stands for softfail, which means that mails outside an included mailserver will be delivered into spam</p></li>
    <div class="divider">&nbsp;</div>
    <li class="along"><p>-all</p><p class="along">Stands for hardfail, which means that mails outside an included mailserver will not be delivered</p></li>
